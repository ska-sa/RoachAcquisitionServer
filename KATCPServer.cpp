...
void cKATCPServer::serverThreadFunction()
{
    ...
    add_version_katcp(m_pKATCPDispatch, const_cast<char*>("katcp-device"), 0, const_cast<char*>("RoachAcquisitionServer-0.11"), (char *) BUILD_STATE);
    ...
    register_double_sensor_katcp(m_pKATCPDispatch, 0,
                                 ...
                                 const_cast<char*>("Hz"),
                                 &getFrequencyFs_KATCPCallback, NULL, NULL, 1023999999, 1024000001, NULL);
    ...
    register_integer_sensor_katcp(m_pKATCPDispatch, 0,
                                  ...
                                  const_cast<char*>("Hz"),
                                  &getClockFrequency_KATCPCallback, NULL, NULL, 255999999, 256000001, NULL);
...
int32_t cKATCPServer::roachSetDspGain_KATCPCallback(struct katcp_dispatch *pKATCPDispatch, int32_t i32ArgC)
{
    ...
    // digital_gain can be fractional-valued
    double dRequestedGain = strtod(arg_string_katcp(pKATCPDispatch, 1), NULL);

    // digital_gain register is unsigned
    if (dRequestedGain < 0)
    {
    ...
    uint32_t ui32Gain = int(dRequestedGain * pow(2,12));
...
void cKATCPServer::cKATCPClientCallbackHandler::receiverGain5GHzLcp_callback(int64_t i64Timestamp_us, double dGain_dB, const std::string &strStatus) {}
