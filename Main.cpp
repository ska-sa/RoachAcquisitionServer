...
int main(int iArgC, char *pchaArgV[])
{
    ...
    oOptions.add_options()
            ...
            ("local-interface,l", boost::program_options::value<string>(&strTenGbELocalInterface)->default_value(string("10.0.3.1")), "Address of local 10 GbE interface to which the Roach is connected.")
            ...
            ("roach-address,r", boost::program_options::value<string>(&strRoachTenGbEInterface)->default_value(string("10.0.3.2")), "IP address of the Roach's 10 GbE port connected to this computer.")
